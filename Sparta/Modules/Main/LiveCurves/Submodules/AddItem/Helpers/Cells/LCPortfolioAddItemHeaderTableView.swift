//
//  LCPortfolioAddItemHeaderTableView.swift
//  Sparta
//
...
class LCPortfolioAddItemHeaderTableView: UITableViewHeaderFooterView {
    ...
    required init?(coder: NSCoder) {
        fatalError("LCPortfolioAddItemHeaderTableView")
    }
