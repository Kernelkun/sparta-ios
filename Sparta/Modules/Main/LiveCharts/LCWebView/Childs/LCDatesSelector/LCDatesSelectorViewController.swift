...
extension LCDatesSelectorViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let dateSelectors = group.dateSelectors
        
        cell.apply(
            dateSelectors: dateSelectors,
            selectedDateSelector: viewModel.selectedDateSelector,
            preferredRowsCount: group.preferredRowsCount
        ) { [unowned self] dateSelector in
