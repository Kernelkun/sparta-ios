...
class LCDatesSelectorTableViewCell: UITableViewCell {
    ...
    private var preferredRowsCount: Int = 4
    ...
    func apply(dateSelectors: [LiveChartDateSelector],
        ...
        self.preferredRowsCount = preferredRowsCount
        _tapClosure = onTap
    ...
    private func setupUI() {
        ...
        let elementWidth: CGFloat = UIScreen.main.bounds.inset(by: .init(top: 0, left: 8, bottom: 0, right: 8)).width / CGFloat(preferredRowsCount)
        let elementsSpace: CGFloat = preferredRowsCount == 5 ? 0 : 0
        ...
        func elementsCountFitWidth() -> Int {
            ...
            while screenWidthWithInsets >= (CGFloat(elementsCount) * elementFullWidth - elementsSpace) {
                elementsCount += 1
            }
...
//            }
            ...
            return min(elementsCount, preferredRowsCount)
        }
