...
class ResultKeyValueUnitsView<T: Hashable>: UIView, Identifiable {
    ...
    func apply(key: String, value: String, valueColor: UIColor, units: String) {
        keyLabel.text = key
