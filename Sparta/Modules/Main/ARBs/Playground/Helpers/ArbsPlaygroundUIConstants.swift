//
//  ArbsPlaygroundUIConstants.swift
//  Sparta
//
...
enum ArbsPlaygroundUIConstants {

    static let separatorLineWidth: CGFloat = 0.3
    static let separatorLineColor: UIColor = .plSeparator
