//
//  BlenderEditPortfolioItemsViewController.swift
//  Sparta
//
...
class BlenderEditPortfolioItemsViewController: BaseTableVMViewController<BlenderEditPortfolioItemsViewModel> {
    ...
    private func configureHeaderView() -> ProfilesView<BlenderProfileCategory> {
...
extension BlenderEditPortfolioItemsViewController {

    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        viewModel.selectedProfile.blenders.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell: EditPortfolioItemsTableViewCell = tableView.dequeueReusableCell(for: indexPath)

        let blender = viewModel.selectedProfile.blenders[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView, editingStyleForRowAt indexPath: IndexPath) -> UITableViewCell.EditingStyle {
        let blenders = viewModel.selectedProfile.blenders[indexPath.row]

        return blenders.isCustom ? .delete : .none
    }
    ...
    override func tableView(_ tableView: UITableView, moveRowAt sourceIndexPath: IndexPath, to destinationIndexPath: IndexPath) {
        let movingItem = viewModel.selectedProfile.blenders[sourceIndexPath.row]
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        ...
        let item = viewModel.selectedProfile.blenders[indexPath.row]
...
extension BlenderEditPortfolioItemsViewController: BlenderEditPortfolioItemsViewModelDelegate {
