//
//  BlenderGradeNestedCollectionViewCell.swift
//  Sparta
//
...
class BlenderGradeNestedCollectionViewCell: UICollectionViewCell {
    ...
    required init?(coder: NSCoder) {
        fatalError("BlenderGradeNestedCollectionViewCell")
    }
    ...
    private func setupUI() {
        ...
        _ = TappableView().then { view in
            ...
            contentView.addSubview(view) {
                ...
                $0.left.equalTo(customImage.snp.right).offset(14)
...
extension BlenderGradeNestedCollectionViewCell: BlenderObserver {
