...
protocol CMPViewControllerDelegate: AnyObject {
    func cmpViewControllerDidPickCountry(_ country: CMPViewController.Country)
}

public class CMPViewController: UITableViewController {
    ...
    weak var delegate: CMPViewControllerDelegate?
    ...
    public override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let country = self.country(for: indexPath)
        delegate?.cmpViewControllerDidPickCountry(country)
        tableView.deselectRow(at: indexPath, animated: true)
    }
}

extension CMPViewController: UISearchResultsUpdating {
